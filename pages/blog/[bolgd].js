...
      <div className='blog-page' id='blogDefault'>
        <div className='blogg-page' id="blogDefault" style={{ backgroundImage: `url("${getStrapiMedia(banner_image)}")` }}>
        {/* <div className='blogg-page' id="blogDefault" style={{ backgroundImage: `url("https://strapi.unboxindustry.com/uploads/Brown_Aesthetic_and_Minimalist_Apartment_Sale_Promotion_Banner_1_5_5118f8fe35.png")`, width: "1100", height: "300" }}> */}
        </div>
      </div>
...
              <span className='description-span' dangerouslySetInnerHTML={{ __html: description }}></span>
              {/*  <Img className='image-class' src={getStrapiMedia(images[index])} alt={title} /> */}
              {/* {images[index] && <Img className='image-class' src={getStrapiMedia(images[index])} alt={title} />} */}
              {images[index]?.data ? (
                <Img className='image-class' src={getStrapiMedia(images[index])} alt={title} />
              ) : (
                <p></p>
