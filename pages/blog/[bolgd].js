...
//       // Determine if the sidebar should be fixed
//       if (firstItemRect.top < 0 && endFormRect.bottom > sidebarRect.height) {
//         sidebar.classList.add('sidebar-fixedmobile');
//       } else {
//         sidebar.classList.remove('sidebar-fixedmobile');
//       }
...
//       // Ensure the sidebar is not fixed when the end form is visible
//       if (endFormRect.top < windowHeight) {
//         sidebar.classList.remove('sidebar-fixedmobile');
//       }
//     };

//     // Use a throttled or debounced version of the scroll handler for better performance
//     const throttledHandleScrollMobile = throttle(handleScrollMobile, 100);

//     window.addEventListener('scroll', throttledHandleScrollMobile);
//     return () => {
//       window.removeEventListener('scroll', throttledHandleScrollMobile);
//     };
//   }, []);
