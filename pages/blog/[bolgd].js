...
//     if (firstItemRect.top < 0 && lastItemRect.bottom > sidebarRect.height) {
//       sidebar.classList.add('sidebar-fixed');
//     } else {
//       sidebar.classList.remove('sidebar-fixed');
//     }

//     if (lastItemRect.bottom <= sidebarRect.height) {
//       sidebar.style.top = `${lastItemRect.bottom - sidebarRect.height}px`;
//     } else {
//       sidebar.style.top = '0px';
//     }
//   };
