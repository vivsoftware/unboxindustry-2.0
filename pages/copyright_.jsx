...
const Copyright = () => {
    return (
        <>
            <Layout4>
                <Head>
                    <title>Copyright - Unbox Industry</title>
                ...
                <div className='container mt-2'>
                    <div className='row mt-2 mb-2' style={{ fontSize: '12px' }}>
                        ...
                        <ol>
                            ...
                            <li><p style={{ fontSize: '16px', lineHeight: '1.7rem' }}>A statement by you, made under penalty of perjury, that you consent to
                                the jurisdiction of the Federal District Court for the judicial district in which your address is located, or if your
                                address is outside the United States, the United States District Court for the Northern District of California, and that you
                                will accept service of process from the person who provided notification of the alleged infringement or an agent of such
                                person.
                            </p>
                            </li>
                        </ol>
