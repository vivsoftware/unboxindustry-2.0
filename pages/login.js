    ...
    return (
        <>
            <Layout4 className="home-page">
                ...
                {/* <marquee style={{ color: '#FF8400', marginTop: '10px', fontSize: '20px' }}><b>This is our new website. If you're an existing user, please reset your password or if you're new then please LogIn to our new website.</b></marquee> */}
