    ...
    <div className="container-fluid">
      <div className="row">
          ...
          <Navbar expand="lg" className="nav-items">
            <Container fluid>
              ...
              <Navbar.Collapse id="navbarScroll">
                <Nav className="" style={{ maxHeight: "100%" }} navbarScroll>
                  <Link href="/">
                    <Nav.Link href="/" className="home-mobile">
                      Home
                    </Nav.Link>
                  </Link>
                  <NavDropdown
                      ...
                      <div className="dropdown-columns">
                        <div className="column">
                          ...
                          {brands?.slice(0, 6).map((brand) => (
                            <Link
                              href={`/brand/${brand.id}-${brand.attributes.brand_slug}`}
                              key={brand.id}
                            >
                              <NavDropdown.Item
                                href={`/brand/${brand.id}-${brand.attributes.brand_slug}`}
                  ...
                  >
                    <Link href="/industries/All">
                      <NavDropdown.Item href="/industries/All">
                    ...
                    {industries?.map((elem) => {
                      return (
                        <Link
                          href={`/industries/${elem.id}-${elem.attributes.CardTitle}`}
                        >
                          <NavDropdown.Item
                            href={`/industries/${elem.id}-${elem.attributes.CardTitle}`}
                          >
                  ...
                  >
                    ...
                    <Link href="#">
                      <NavDropdown.Item href="/layout/UnboxVideos">
                        Unbox Videos
                      </NavDropdown.Item>
                    </Link>
                    <Link href="#">
                      <NavDropdown.Item href="/layout/CaseStudies">
                        Case Studies
                      </NavDropdown.Item>
                    </Link>
                  </NavDropdown>
        ...
        <div className="col-xl-2 col-md-4 col-sm-6 phone-number">
          <span style={{ color: "#FF8400", marginTop: "13px" }}>
            {" "}
